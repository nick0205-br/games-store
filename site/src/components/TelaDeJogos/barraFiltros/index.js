            ...
            <div className="container">
                ...
                <div className="box-filtro">                
                    ...
                    <div>
                        ...
                        <div className="camp-filtro"> <input type="radio" name="valor" className="checkbox-round" onClick={props.filtro} value="ps5"/> <p>Ps5</p></div>
                        ...
                        <div className="camp-filtro"> <input type="radio" name="valor" className="checkbox-round" onClick={props.filtro} value="ps3"/> <p>Ps3</p></div>
                        <div className="camp-filtro"> <input type="radio" name="valor" className="checkbox-round" onClick={props.filtro} value="ps2"/> <p>Ps2</p></div>
                        <div className="camp-filtro"> <input type="radio" name="valor" className="checkbox-round" onClick={props.filtro} value="ps1"/> <p>Ps1</p></div>
                        <div className="camp-filtro"> <input type="radio" name="valor" className="checkbox-round" onClick={props.filtro} value="atari"/> <p>Atari</p></div>
                        <div className="camp-filtro"> <input type="radio" name="valor" className="checkbox-round" onClick={props.filtro} value="gb"/> <p>Gameboy</p></div>
                        <div className="camp-filtro"> <input type="radio" name="valor" className="checkbox-round" onClick={props.filtro} value="sw"/> <p>Nintendo Switch</p></div>
                        <div className="camp-filtro"> <input type="radio" name="valor" className="checkbox-round" onClick={props.filtro} value="wii"/> <p>Nintendo Wii</p></div>
                        <div className="camp-filtro"> <input type="radio" name="valor" className="checkbox-round" onClick={props.filtro} value="sn"/> <p>Super Nintendo</p></div>
                    </div>
                </div>
                <div className="box-filtro">
                    ...
                    <div>
                        ...
                        <div className="camp-filtro"> <input type="radio" name="valor" className="checkbox-round" onClick={props.filtro} value="casual"/> <p>Casual</p></div>
                    </div>  
                </div>
            </div>
        </div>
