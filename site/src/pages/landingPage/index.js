            ...
            <section className='jogos-populares'>
                ...
                <div className='slider'>
                    ...
                    <div className='slides'>
                        ...
                        <div className='slide' onClick={() => Navigate('/produto/1/detalhe')}>
            ...
            <section className="faixa-cadastro">
                ...
                <div data-aos="slide-up" className="container-boxs">
                    <div className="box-esquerda">
                        <img id='img-format-boxes-l' src="/computador.png" alt="computador com teclado e mouse" />
                    ...
                    <div className="box-direita">
                        <img id='img-format-boxes-r' src="/controle.png" alt="" />
